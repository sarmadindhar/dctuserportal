        ...
        <div className="relative isolate px-6 pt-14 lg:px-8 w-full h-full bg-center bg-no-repeat bg-cover bg-[url('../images/assets/hero-banner.png')]" >
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1 className="text-6xl font-bold tracking-tight text-[#2D1015] mt-5">{getByLocale(cms.home,'hero_banner_heading')}</h1>
              <p className="mt-6 text-lg leading-8 text-[#2D1015]"> {getByLocale(cms.home,'hero_banner_text')} </p>
